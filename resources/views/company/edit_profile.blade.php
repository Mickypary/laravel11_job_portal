            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12">
                        <form action="{{ route('company_update_profile') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-group">
                                      ...
                                      @else
                                        <img src="{{ asset('uploads/'. Auth::guard('company')->user()->logo) }}" alt="logo" class="logo" />
                                      @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="contact_person" class="form-control" value="{{ Auth::guard('company')->user()->contact_person }}"
                                        />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                      <select name="company_location_id" class="form-control select2">
                                        ...
                                        <option value="{{ $item->id }}" {{ Auth::guard('company')->user()->company_location_id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <select name="company_size_id" class="form-control select2">
                                            ...
                                            <option value="{{ $item->id }}" {{ Auth::guard('company')->user()->company_size_id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <select name="company_industry_id" class="form-control select2">
                                          ...
                                          <option value="{{ $item->id }}" {{ Auth::guard('company')->user()->company_industry_id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                          @endforeach
                                        </select>
                                    </div>
                                  ...
                                  <div class="form-group">
                                      <select name="founded_on" class="form-control select2">
                                          @for($i=1900; $i<= date("Y"); $i++ )
                                            <option value="{{ $i }}" {{ Auth::guard('company')->user()->founded_on == $i ? 'selected' : '' }}>{{ $i }}</option>
                                          @endfor
                                      </select>
                                  </div>
                                  <div class="clearfix"></div>
                              ...
                              <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="opening_hour_mon" class="form-control" value="{{ Auth::guard('company')->user()->opening_hour_mon }}" />
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="">Opening Hour (Tuesday)</label>
                                    <div class="form-group">
                                        <input type="text" name="opening_hour_tue" class="form-control" value="{{ Auth::guard('company')->user()->opening_hour_tue }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="opening_hour_wed" class="form-control" value="{{ Auth::guard('company')->user()->opening_hour_wed }}" />
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="">Opening Hour (Thursday)</label>
                                    <div class="form-group">
                                        <input type="text" name="opening_hour_thu" class="form-control" value="{{ Auth::guard('company')->user()->opening_hour_thu }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="opening_hour_fri" class="form-control" value="{{ Auth::guard('company')->user()->opening_hour_fri }}" />
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="">Opening Hour (Saturday)</label>
                                    <div class="form-group">
                                        <input type="text" name="opening_hour_sat" class="form-control" value="{{ Auth::guard('company')->user()->opening_hour_sat }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="opening_hour_sun" class="form-control" value="{{ Auth::guard('company')->user()->opening_hour_sun }}" />
                                    </div>
                                </div>
